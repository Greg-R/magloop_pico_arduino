...
//      else
      ...
      break;
    case State::state2:
      frequency = ChangeFrequency(frequency); // Alter the frequency using encoders.  Enter button returns frequency.
...
*****/
int32_t DisplayManagement::ChangeFrequency(int32_t frequency)
{
  int halfScreen, insetMargin;
